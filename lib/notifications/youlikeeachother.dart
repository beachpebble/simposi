          ...
          child: Column(
            children: [
              ...
              Row(
                children: [
                  Expanded(
                    child: Text('Making new friends is easy',
                    style: TextStyle(
                      fontWeight: FontWeight.w900,
                      color: SimposiAppColors.simposiDarkGrey,
                    ),),
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  SizedBox(width: 10),
                  Image.asset('assets/images/ratingheart1.png',
                    width: 30,
                  ),
                  SizedBox(width: 10),
                  Text('like each other',
                    style: TextStyle(
                      fontSize: 17,
                      color: SimposiAppColors.simposiDarkGrey,
                      fontWeight: FontWeight.w900,
              ...
              SizedBox(height: 20),
              Text('It takes at least 50hrs to make it official so keep it going by connecting IRL.',
