...
class Signup7LocationState extends Equatable {
  const Signup7LocationState(
      {required this.selectedLocation, required this.searchResults, required this.range});
  ...
  static Signup7LocationState initial() => Signup7LocationState(selectedLocation: null, searchResults: [], range: 1);
